...
$( document ).on( "pagecreate", ".jqm-categories", function( event ) {
	var search,
		page = $( this ),
		that = this,
	...
	// Turn off autocomplete / correct for categories search
	...
	if ( $( event.target ).hasClass( "jqm-categories-search-results") ) {
...
$( document ).one( "pagecreate", ".jqm-categories", function( event ) {
